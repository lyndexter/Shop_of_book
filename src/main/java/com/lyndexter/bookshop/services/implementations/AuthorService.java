...
public class AuthorService extends ImplementedService<Author, Integer> {
    ...
    private JpaRepository<Author, Integer> authorRepository;
    ...
    protected Author changeEntity(Author changingEntity, Author entity) {
        changingEntity.setName(
                entity.getName() != null ? entity. getName() : changingEntity.getName());
        changingEntity.setAge(entity.getAge() != null ? entity.getAge() : changingEntity.getAge());
        changingEntity.setSurname(entity.getSurname() != null ? entity.getSurname() : changingEntity.getSurname());
        changingEntity.setNationality(
                entity.getNationality() != null ? entity.getNationality() : changingEntity.getNationality());
